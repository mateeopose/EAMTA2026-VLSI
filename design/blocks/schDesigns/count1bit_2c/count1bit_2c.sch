...
N -280 -50 -276 -50 {lab=CE}
N -280 -10 -276 -10 {lab=Dn}
N -210 100 -210 104 {lab=vdd}
N -210 236 -210 240 {lab=vss}
N -360 -50 -300 -50 {lab=CE}
...
N -70 50 -50 50 {lab=CLK1}
N -360 60 -210 60 {lab=vss}
N -350 -120 -210 -120 {lab=vdd}
N -360 -120 -350 -120 {lab=vdd}
N -90 50 -70 50 {lab=CLK1}
N -90 -60 -90 50 {lab=CLK1}
N -90 -60 -10 -60 {lab=CLK1}
N -100 -30 -80 -30 {lab=#net1}
N -190 80 -170 80 {lab=vdd}
N -300 -140 -280 -140 {lab=Dn}
N 70 50 90 50 {lab=CLK2}
N -300 -50 -300 110 {lab=CE}
N -330 -10 -330 160 {lab=Dn}
N -330 -10 -290 -10 {lab=Dn}
N -330 -100 -330 -10 {lab=Dn}
N -330 -110 -330 -100 {lab=Dn}
N -330 -140 -300 -140 {lab=Dn}
N -330 -140 -330 -110 {lab=Dn}
...
C {iopin.sym} -10 -60 0 0 {name=p6 lab=CLK1}
C {iopin.sym} 30 140 0 0 {name=p8 lab=CLR}
C {iopin.sym} -90 170 0 0 {name=p9 lab=Sout}
C {iopin.sym} -360 60 0 1 {name=p10 lab=vss}
C {iopin.sym} -360 -50 0 1 {name=p11 lab=CE}
C {iopin.sym} -360 -120 0 1 {name=p12 lab=vdd}
C {blocks/schDesigns/dff2c/dff2c.sym} 10 50 0 0 {name=x1}
C {iopin.sym} 90 50 0 0 {name=p13 lab=CLK2}
